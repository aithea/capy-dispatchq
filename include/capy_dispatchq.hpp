...
namespace capy::dispatchq {
    ...
    typedef std::vector<capy::dispatchq::base_thread_pool::task_yield<void>> queued_tasks;
    ...
    protected:
        std::shared_ptr<capy::dispatchq::base_thread_pool>  pool_;
    ...
    namespace main {
         ...
         * @param task
         */
        void async(capy::dispatchq::function task);
